...
All **349,073** pinned raw parents reconcile exactly through the parent ledger. The pipeline retained **139,819** finite scalar children with canonical endpoint keys.
...
| gut_wall | 27,713 | 5,540 | 1,836 | 68 | 576 |
